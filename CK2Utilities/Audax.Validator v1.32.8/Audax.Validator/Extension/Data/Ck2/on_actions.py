...
# list of [{'root': X, 'from': X, 'fromfrom': X, 'fromfromfrom': X}]
Exports.OnActions = []

seen_names = set()

def add_action(name, root_scope, from_scope=None, from_from_scope=None, from_from_from_scope=None):
	...
	if from_from_scope:
		effect_scope_target_name = effect_scope_target_name + 'FromFrom' + from_from_scope
	if from_from_from_scope:
		effect_scope_target_name = effect_scope_target_name + 'FromFromFrom' + from_from_from_scope
...
# root=char, from=wonder, from_from=prov
for name in [
	...
	add_action(name, root_scope='Char', from_scope='Wonder', from_from_scope='Prov')

# root=char, from=wonder_upgrade, from_from=wonder, from_from_from=prov
for name in [
	...
	add_action(name, root_scope='Char', from_scope='WonderUpgrade', from_from_scope='Wonder', from_from_from_scope='Prov')
...
add_action('on_wonder_owner_change', root_scope='Char', from_scope='Wonder', from_from_scope='Char', from_from_from_scope='Prov')
